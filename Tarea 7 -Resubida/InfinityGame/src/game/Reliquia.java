...
public class Reliquia {	
	...
	public Reliquia(boolean booleano, boolean salud) {
        ...
        private void activarSoloAlta(Jugador jugador){
            ...
            if(valorRandom==1){
                System.out.println("Se ha activado la reliquia! Toda tu vida será restaurada");
                jugador.setVida(15);
            }
        }
        ...
        private void activarSoloSalud(Jugador jugador){
            ...
            if(valorRandom==1){
                System.out.println("Se ha activado la reliquia! Ganas un punto extra para meditar");
